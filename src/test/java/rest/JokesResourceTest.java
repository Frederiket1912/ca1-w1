...
public class JokesResourceTest {
    ...
    public void setUp() {
        ...
        j1 = new Jokes("Hvordan får man fisk til at grine?");
        j2 = new Jokes("Hvad sagde den store skorsten til den lille?");
        try {
...
//    }
    ...
    public void testGetAllJokes() {
        given()
                ...
                .statusCode(HttpStatus.OK_200.getStatusCode())
                .body("joke", hasItems("Hvordan får man fisk til at grine?","Hvad sagde den store skorsten til den lille?"));
    }
}
